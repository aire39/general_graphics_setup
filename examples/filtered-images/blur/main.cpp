...
int32_t main(int32_t argc, char*argv[])
{
  ...
  constexpr int32_t repeat_filter_amount = 10;
  std::chrono::high_resolution_clock::time_point start = std::chrono::high_resolution_clock::now();
  sprite.ProcessFilter(filter::functions::cpu::parallel_vectorize::gaussian_blur_3x3, save_filter, repeat_filter_amount);
